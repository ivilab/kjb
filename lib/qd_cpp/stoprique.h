...
public:
    ...
    enum {
        BAD_LOC = 0 ///< a good external locator is always positive, this isn't
    };
...
private:
    ...
    struct SatLoc {
        ...
        Loc_tp spqloc;  ///< biased external locator to this record
    ...
    struct Compo {
        ...
        Loc_tp loc; ///< this element's locator in its sub-queue (inner loc)
