...
/* $Id: test_normal_inverse_chi_squared.cpp 20403 2016-02-20 18:55:27Z jguan1 $ */
...
int main(int argc, char** argv)
{
    ...
    Normal_inverse_chi_squared_distribution nig(mu, S.inverse(), a, b);
