...
/* $Id: pt_face_2d_trajectory.h 18329 2014-12-02 04:29:44Z ksimek $ */
...
template <>
inline
bool kjb::pt::Face_2d_trajectory_element::parse(const std::string& /*line*/)
{
//    using namespace std;
...
template <>
inline
void kjb::pt::Face_2d_trajectory_element::write(std::ofstream& /*ofs*/) const
{
...
template <>
inline
void kjb::pt::Face_2d_trajectory_element::write_invalid(std::ofstream& ofs)
{
