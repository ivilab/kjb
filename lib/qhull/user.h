...
/* $Id: user.h 20918 2016-10-31 22:08:27Z kobus $ */
...
#define REALfloat 0   /* use 0 for double precision */
#else
#define REALfloat 1
#endif
/*
...
/*
// Changes made by Kobus. In essence this is no change, since we
// have opted for qh_rand() which is the default.
*/

#define USE_QHULL_RAND

#ifdef USE_QHULL_RAND
#    define qh_RANDOMtype 5
#else
#    ifdef SUN4
#        define qh_RANDOMtype 3
#    endif

#    ifdef SUN5
#        define qh_RANDOMtype 4
#    endif
#endif
/*
   End Kobus
