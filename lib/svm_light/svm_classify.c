...
/* $Id: svm_classify.c 4727 2009-11-16 20:53:54Z kobus $ */
...
static char docfile[200];
static char modelfile[200];
static char predictionsfile[200];

void read_input_parameters_classify(int, char **, char *, char *, char *, long *, 
			   long *);
...
int main_classify (int argc, char* argv[])
{
  ...
  read_input_parameters_classify(argc,argv,docfile,modelfile,predictionsfile,
  ...
  model=read_model_svm(modelfile);
...
void read_input_parameters_classify(int argc, char **argv, char *docfile, 
