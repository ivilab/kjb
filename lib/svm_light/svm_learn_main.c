...
/* $Id: svm_learn_main.c 20654 2016-05-05 23:13:43Z kobus $ */
...
static char docfile[200];           /* file with training examples */
static char modelfile[200];         /* file for resulting classifier */
static char restartfile[200];       /* file with initial alphas */

void   read_input_parameters_learn(int, char **, char *, char *, char *, long *, 
			     LEARN_PARM *, KERNEL_PARM *);
void   wait_any_key(void);
void   print_help_learn(void);
...
{  
  ...
  read_input_parameters_learn(argc,argv,docfile,modelfile,restartfile,&verbosity,
			&learn_parm,&kernel_parm);
...
void read_input_parameters_learn(int argc,char *argv[],char *docfile,char *modelfile,
