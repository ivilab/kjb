...
/* $Id: signature.c 4727 2009-11-16 20:53:54Z kobus $ */
...
*/
static void
  ComputeMessageDigest _Declare((MessageDigest *)),
  InitializeMessageDigest _Declare((MessageDigest *)),
...
%
*/
static void TransformMessageDigest(MessageDigest *message_digest, long unsigned int *message)
{
...
%
*/
static void UpdateMessageDigest(MessageDigest *message_digest, unsigned char *input_message, long unsigned int message_length)
{
  int
    number_bytes;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%  Function ColormapSignature computes a digital signature from the image
%  colormap.  This signature uniquely identifies the colormap and is convenient
%  for determining if the colormap of a sequence of images is identical when
%  animating.  The digital signature is from RSA Data Security MD5 Digest
%  Algorithm described in Internet draft [MD5], July 1992.
