...
6 sentence_number length word_1 tag_1 word_2 tag_2 ... word_n tag_n 

e.g.
6 1 13 Takeover NN experts NNS said VBD they PRP doubted VBD the DT financier NN would MD make VB a DT bid NN by IN himself PRP

[2] unary events

3 nt_number parent_number word tag parent-nonterminal headchild-nonterminal left-subcat right-subcat

e.g.
3 1 0 said VBD TOP S 00000  00000 
3 2 1 said VBD S VP 10000  00000

[3] dependency events

2 nt_number parent_number head_number mod-word mod-tag head-word head-tag mod-nt parent-nt head-nt subcat distance <coordination> <punctuation>
...
void read_events(FILE *file,hash_table *hash,int max, bool shared = false);
