/* $Id: grammar.y,v 2.0.1.16 1995/11/03 03:33:31 greyham Exp $
 *
...
/* whenever we change include files */
%token T_BASEFILE
...
parameter_declaration
	: opt_comment declaration_specifiers declarator opt_comment
	{
	    new_parameter(&$$, &$2, $3, $1, $4);
	}
	| opt_comment declaration_specifiers abstract_declarator opt_comment
	{
	    new_parameter(&$$, &$2, $3, $1, $4);
	}
