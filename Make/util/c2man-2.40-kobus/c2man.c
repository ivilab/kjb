/* $Id: c2man.c,v 2.0.1.38 1995/11/03 03:34:13 greyham Exp $
 *
...
char **argv;
{
    ...
    /* Scan command line options. */   /* Kobus: Added "C:A"  */
                                       /* Kobus: Also removed the ":" after 
                                       // the k. (Ie "k:b"->"kb"). 
                                       */
    while ((c = getopt(argc, argv,
                       "C:AP:D:F:I:psU:Vvo:eM:H:G:gi:x:S:l:LT:nO:kbB"))
								    != EOF)
    {
	switch (c) {
	case 'A':     /* Kobus */
